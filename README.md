...
```
bash <(curl -Ls https://raw.githubusercontent.com/rahman8521/3x-ui/master/install.sh)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/rahman8521/3x-ui/master/install.sh) v2.1.3
```
